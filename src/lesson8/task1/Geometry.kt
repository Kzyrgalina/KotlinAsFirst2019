...
fun diameter(vararg points: Point): Segment {
    ...
    return Segment(points[current.first], points[current.second])
}
...
fun circleByDiameter(diameter: Segment): Circle {
    val centerX = (diameter.begin.x + diameter.end.x) / 2.0
    val centerY = (diameter.begin.y + diameter.end.y) / 2.0
