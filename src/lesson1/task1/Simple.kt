...
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int): Double = sagenes * 48 * 4.445 / 100 +
        arshins * 48.0 / 3 * 4.445 / 100 + vershoks * 4.445 / 100
 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int): Double = (deg + min * 1.0 / 60 + sec * 1.0 / 3600) * PI / 180
...
fun accountInThreeYears(initial: Int, percent: Int): Double =
    initial *  (1 + percent * 1.0 / 100).pow(3)
